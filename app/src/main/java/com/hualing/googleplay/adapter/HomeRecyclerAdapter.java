...
//	private List<HomeJson> mData;
	...
	private List<HomeJson.HomeAppInfo> mAppData;

	public HomeRecyclerAdapter(List<HomeJson.HomeAppInfo> mAppData) {
	...
	public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
		HomeJson.HomeAppInfo info = mAppData.get(position);
